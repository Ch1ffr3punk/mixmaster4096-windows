# mixmaster4096-windows

To set the path for mix.exe in the current directory, use: set MIX3PATH=.\  
...
Please note: For sendmail.exe you need tor.exe, listening on port 9050    
installed, or when using the Nym Mixnet port 1080 enabled in sendmail.cfg.  
